...
nodules_detected = "./annotations/batch_99_faster_rcnn_dconv_c3-c5_r50_fpn_1x_768px_output_nms_0.1_upp25d-9x48x48.csv"
gt = "./annotations/lung_data_batch_99.csv"
output = "./annotations/batch_99_faster_rcnn_dconv_c3-c5_r50_fpn_1x_768px_output_nms_0.1_upp25d-9x48x48_w_gt.csv"


def main():
    # nd_csv = pd.read_csv(nodules_detected, header=None)
    nd_csv = pd.read_csv(nodules_detected)
